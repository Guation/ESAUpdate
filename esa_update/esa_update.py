...
# https://github.com/Guation/ESAUpdate
...
from esa_update.esa_api import init
from esa_update.http_server import run_server
from esa_update.version import VERSION
from esa_update.addr_tool import convert_addr
...
def main():
    parser = argparse.ArgumentParser(description='ESAUpdate', add_help=False, allow_abbrev=False, usage=argparse.SUPPRESS)
